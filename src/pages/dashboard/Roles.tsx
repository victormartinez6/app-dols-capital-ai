...
export default function Roles() {
  ...
  const getDefaultPermissions = (): PermissionOption[] => {
    return [
      // Permissões de Menu
      { key: 'menu:dashboard', description: 'Menu: Dashboard', category: 'Menus' },
      { key: 'menu:clients', description: 'Menu: Clientes', category: 'Menus' },
      { key: 'menu:proposals', description: 'Menu: Propostas', category: 'Menus' },
      { key: 'menu:pipeline', description: 'Menu: Pipeline', category: 'Menus' },
      { key: 'menu:teams', description: 'Menu: Equipes', category: 'Menus' },
      { key: 'menu:roles', description: 'Menu: Perfis', category: 'Menus' },
      { key: 'menu:users', description: 'Menu: Usuários', category: 'Menus' },
      { key: 'menu:settings', description: 'Menu: Configurações', category: 'Menus' },
      { key: 'menu:webhooks', description: 'Menu: Webhooks', category: 'Menus' },
      { key: 'menu:my_registration', description: 'Menu: Meu Cadastro', category: 'Menus' },
      
      // Dashboard com granularidade
      { key: 'view:own_dashboard', description: 'Visualizar próprio dashboard', category: 'Dashboard' },
      { key: 'view:team_dashboard', description: 'Visualizar dashboard da equipe', category: 'Dashboard' },
      { key: 'view:all_dashboard', description: 'Visualizar todos os dashboards', category: 'Dashboard' },
      
      // Clientes
      { key: 'view:own_clients', description: 'Visualizar próprios clientes', category: 'Clientes' },
      { key: 'view:team_clients', description: 'Visualizar clientes da equipe', category: 'Clientes' },
      { key: 'view:all_clients', description: 'Visualizar todos os clientes', category: 'Clientes' },
      { key: 'edit:clients', description: 'Editar clientes', category: 'Clientes' },
      { key: 'delete:clients', description: 'Excluir clientes', category: 'Clientes' },
      
      // Propostas
      { key: 'view:own_proposals', description: 'Visualizar próprias propostas', category: 'Propostas' },
      { key: 'view:team_proposals', description: 'Visualizar propostas da equipe', category: 'Propostas' },
      { key: 'view:all_proposals', description: 'Visualizar todas as propostas', category: 'Propostas' },
      { key: 'edit:proposals', description: 'Editar propostas', category: 'Propostas' },
      { key: 'delete:proposals', description: 'Excluir propostas', category: 'Propostas' },
      { key: 'approve:proposals', description: 'Aprovar propostas', category: 'Propostas' },
      { key: 'reject:proposals', description: 'Rejeitar propostas', category: 'Propostas' },
      
      // Pipeline
      { key: 'view:own_pipeline', description: 'Visualizar próprio pipeline', category: 'Pipeline' },
      { key: 'view:team_pipeline', description: 'Visualizar pipeline da equipe', category: 'Pipeline' },
      { key: 'view:all_pipeline', description: 'Visualizar todos os pipelines', category: 'Pipeline' },
      { key: 'edit:pipeline', description: 'Editar pipeline', category: 'Pipeline' },
      
      // Usuários
      { key: 'view:users', description: 'Visualizar usuários', category: 'Usuários' },
      { key: 'edit:users', description: 'Editar usuários', category: 'Usuários' },
      { key: 'delete:users', description: 'Excluir usuários', category: 'Usuários' },
      
      // Perfis
      { key: 'view:roles', description: 'Visualizar perfis', category: 'Perfis' },
      { key: 'edit:roles', description: 'Editar perfis', category: 'Perfis' },
      { key: 'delete:roles', description: 'Excluir perfis', category: 'Perfis' },
      
      // Equipes
      { key: 'view:teams', description: 'Visualizar equipes', category: 'Equipes' },
      { key: 'edit:teams', description: 'Editar equipes', category: 'Equipes' },
      { key: 'delete:teams', description: 'Excluir equipes', category: 'Equipes' },
      
      // Webhooks
      { key: 'view:webhooks', description: 'Visualizar webhooks', category: 'Webhooks' },
      { key: 'edit:webhooks', description: 'Editar webhooks', category: 'Webhooks' },
      
      // Configurações
      { key: 'view:settings', description: 'Visualizar configurações', category: 'Configurações' },
      { key: 'edit:settings', description: 'Editar configurações', category: 'Configurações' },
      
      // Meu Cadastro
      { key: 'view:profile', description: 'Visualizar perfil', category: 'Meu Cadastro' },
      { key: 'edit:profile', description: 'Editar perfil', category: 'Meu Cadastro' },
      { key: 'change:password', description: 'Alterar senha', category: 'Meu Cadastro' },
    ];
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-black text-white">
      {/* Cabeçalho */}
      <div className="flex justify-between items-center mb-6 bg-black p-4 rounded-md border border-gray-800">
        <h1 className="text-2xl font-bold text-white">Gerenciamento de Perfis</h1>
        {canPerformAction('roles', 'edit') && (
          <button
        ...
        <div className="bg-black shadow-md rounded-lg overflow-hidden border border-gray-800">
          <table className="min-w-full divide-y divide-gray-800">
            ...
            <tbody className="bg-black divide-y divide-gray-800">
              {roles.map((role) => (
                <tr key={role.id} className="hover:bg-gray-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    {canPerformAction('roles', 'delete') && !role.isSystem && (
                      <button
      ...
      {showRoleModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-black rounded-lg w-full max-w-4xl max-h-[90vh] overflow-auto border border-gray-800">
            <div className="p-6">
              ...
              <div className="mb-6 bg-black p-4 rounded-md border border-gray-800">
                      ...
                      {permissions.map((permission) => (
                        <div key={permission.key} className="flex items-center">
                          <input
                            ...
                            className="mr-2 h-4 w-4 text-black rounded focus:ring-gray-700 bg-gray-700 border-gray-600"
                          />
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-900 disabled:bg-gray-800 disabled:text-gray-300"
                >
